...
export default async function ReserverPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { salon, prestations, categories, dispos, delaiMinReservationHeures, planningHorizonJours, planningOuvertureMode, planningOuvertureJour, modeReservation, planningDateLimite } = result;
