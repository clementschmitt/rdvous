...
export default async function PublicSalonPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="rdvous-page-body" style={{ minHeight: "100vh", background: "#f7f7f5", fontFamily: "'Inter', system-ui, sans-serif", overflowX: "clip", boxSizing: "border-box" }}>
      <style>{`
      ...
      <AppHeader retour retourAccueil capacitorSeulement action="compte" />
