      ...
      {tab === "dispos" && (
        <Section titre="Disponibilités">
          <div style={{ textAlign: "center", padding: "40px 0", color: "#bbb" }}>
            ...
            <div style={{ fontSize: 14, fontWeight: 600, color: "#999", marginBottom: 6 }}>Bientôt disponible</div>
            <div style={{ fontSize: 13, color: "#bbb" }}>Définissez vos horaires de travail et congés ici.</div>
          </div>
        </Section>
      )}
